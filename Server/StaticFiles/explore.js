            ...
            if (!currentPost || currentPost.post_id !== post.post_id) {
                ...
                async function checkIfAlreadyFollowingUser(post_user_id) {
                    try {
                        const user_id = await getCurrentUserId();
                        jsonData = { user_id: user_id, post_user_id: post_user_id };
                        const response = await fetch('http://localhost:3000/api/follows/checkIfUserFollows', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
                ...
                async function addFollow(user_id, post_user_id) {
                    try {
                        jsonData = { user_id: user_id, post_user_id: post_user_id };
                        const response = await fetch('http://localhost:3000/api/follows/addFollow', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
                ...
                async function removeFollow(user_id, post_user_id) {
                    try {
                        jsonData = { user_id: user_id, post_user_id: post_user_id };
                        const response = await fetch('http://localhost:3000/api/follows/removeFollow', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
...
const loadFeed = async() => {
    try {
        ...
        const response = await fetch('http://localhost:3000/api/posts/explore', {
            method: 'POST',
            body: JSON.stringify({ userCountry: userCountry }),
            headers: {
                'Content-Type': 'application/json',
            },
        });
